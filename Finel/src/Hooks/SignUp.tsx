...
if(inputValue.Name && inputValue.Password && inputValue.email){
  ...
  if (!passwordRegex.test(inputValue.Password)) {
    ...
    return;
      ...
      axios .post("https://64f3989fedfa0459f6c6b193.mockapi.io/Userinfo", {
...
<div className=" absolute">
      ...
      <p className="text-center text-6xl font-semibold text-[#3E68AE] mt-10 mb-20">Sign-Up</p>

    <div
      className="w-full transform  mb-5 border-b-2 bg-transparent flex flex-col text-lg duration-300 focus-within:border-black" >
