  ...
  return (
    <div>
      ...
      <div className="h-fit flex flex-row-reverse lg:gap-20 sm:gap-5 md:gap-10 max-lg:gap-10 justify-center">
        <img className="lg:w-[30rem] sm:w-[15rem] md:w-[15rem]" src={imag1} alt="" />
      ...
      <div className="flex flex-col justify-center items-center gap-10 mb-20">
        ...
        <div className=" flex flex-row justify-center gap-10 lg:w-10/12 md:w-9/12 sm:w-3/4  sm:gap-5 h-fit">
          <div className="flex flex-col justify-center items-center text-center bg-[#3E68AE] lg:w-1/6 sm:w-1/4 h-5/6 sm:gap-5 md:w-1/4  md:gap-5 lg:gap-20 rounded-2xl">
            <img className="lg:w-40 mt-10 sm:w-20" src={icon1} alt="" />
            <p className="lg:text-2xl w-20 mb-10 sm:text-lg font-bold ">Expense Track</p>
          </div>

          <div className="flex flex-col justify-center items-center text-center bg-[#00AEB1] lg:w-1/6 sm:w-1/4 h-5/6 sm:gap-5 lg:gap-20 rounded-2xl">
          ...
          <div className="flex flex-col justify-center items-center text-center bg-[#F7F5FA] lg:w-1/6 sm:w-1/4 h-5/6 sm:gap-5 lg:gap-20 rounded-2xl">
      ...
      <div className=" flex flex-col justify-center items-center mt-32 sm:mb-5 sm:mt-20 lg:mb-20 ">
        ...
        <div className="flex flex-row justify-center w-full lg:gap-9 sm:gap-5 mb-10">
          <div className=" flex flex-col justify-center items-center text-center bg-[#3E68AE] sm:w-1/4 lg:w-1/6 h-5/6 lg:gap-5 sm:gap-1 rounded-3xl">
