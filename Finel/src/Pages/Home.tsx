    ...
    <div>
      ...
      <div className="flex flex-col justify-center items-center gap-10 mb-20">
        <div className="mt-20 flex gap-3 justify-center">
          <h1 className=" text-5xl font-bold">Take Control Of Your </h1>
          <p className="text-5xl font-bold text-[#00AEB1]">Money</p>
        </div>
      ...
      <div className="flex flex-row justify-center items-center ">
        ...
        <div className="w-1/2 flex flex-col justify-center items-center gap-10">
          <h1 className=" text-5xl font-extrabold w-80 text-center">
            What is <b className="text-5xl text-[#C1CFE5]">Wise Wallet</b>
          </h1>

          <p className=" text-center w-9/12 text-2xl">
      ...
      <div className="bg-[#C0E6E6] flex  flex-col justify-center items-center my-10">
        <p className=" w-1/4 text-center text-3xl m-24 mb-10">
      ...
      <div className=" flex flex-col justify-center items-center mt-32 mb-20 ">
        <p className="text-center font-extrabold text-5xl mb-20">
          Website{" "}
          <b className="text-center text-5xl mb-20 text-[#B2E0E0]">
            Developer{" "}
          </b>
        </p>
        ...
        <div className="flex flex-row justify-center w-full gap-9 mb-10">
          <div className=" flex flex-col justify-center items-center text-center bg-[#3E68AE] w-1/6 h-5/6 gap-5 rounded-3xl">
            <p className="text-white text-3xl w-20 mt-10 mb-10 font-bold">
              Nouf Jafari
            </p>
