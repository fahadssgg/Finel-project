...
export default function Home() {
  return (
    <div>
      ...
      <img className="lg:h-[40rem] lg:w-[40rem] sm:w-[15rem] md:w-[15rem]" src={Header2} alt="" />
      <img className="lg:h-[30rem] lg:w-[40rem] sm:w-[15rem] md:w-[15rem] mt-20" src={Header1} alt="" />
      </div>

      <div className="bg-[#C0E6E6] flex flex-col justify-center items-center gap-10 mb-10 mt-10">
        ...
        <div className=" flex flex-row justify-center gap-2 lg:w-10/12 md:w-9/12 sm:w-3/4  sm:gap-5 h-fit mb-20">
          <div className=" hover:scale-110 flex flex-col justify-center items-center text-center bg-[#3E68AE] h-fit lg:w-1/5 sm:w-1/4 sm:gap-5 md:w-1/4  md:gap-5 lg:gap-10 rounded-2xl">
            <img className="lg:w-32 mt-10 sm:w-20" src={icon1} alt="" />
            <p className="lg:text-2xl w-20 mb-10 sm:text-lg font-bold ">Expense Track</p>
          </div>

          <div className=" hover:scale-110 flex flex-col justify-center items-center text-center bg-[#00AEB1] h-fit lg:w-1/5 sm:w-1/4 sm:gap-5 lg:gap-10 rounded-2xl">
            <img className="lg:w-32 mt-10 sm:w-20" src={icon2} alt="" />
            <p className="lg:text-2xl w-40 mb-10 sm:text-lg font-bold"> Money Management</p>
          </div>

          <div className=" hover:scale-110 flex flex-col justify-center items-center text-center bg-[#F7F5FA] h-fit lg:w-1/5 sm:w-1/4 sm:gap-5 lg:gap-10 rounded-2xl">
            <img className="lg:w-32 mt-10 sm:w-20" src={icon3} alt="" />
      ...
      <div className="flex flex-row justify-center items-center ">
        <div className="hover:scale-90 lg:w-1/3 sm:w-2/5 mt-20 sm:mb-16">
      ...
      <div className=" flex flex-col justify-center items-center mt-32 sm:mb-5 sm:mt-20 lg:mb-20 ">
        ...
        <div className="flex flex-row justify-center w-full lg:gap-9 sm:gap-5 mb-10">
          ...
          <div className="hover:scale-90 flex flex-col justify-center items-center text-center bg-[#00AEB1] lg:w-1/6 sm:w-1/4 h-5/6 lg:gap-5 sm:gap-1 rounded-3xl">
